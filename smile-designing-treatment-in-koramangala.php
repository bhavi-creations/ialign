            ...
            <div class="row g-0 invisalign_first_section_row">
                        ...
                        <div class="invisalign_first_section_actions">
                            ...
                            <!-- <a href="contact.php" class="invisalign_first_section_video_btn">
                                ...
                                <span class="invisalign_first_section_video_text">
                                    ...
                                    <small>Share your smile goals with us</small>
                                </span>
                            </a> -->
                        </div>
                    </div>
                ...
                <div class="col-lg-7 invisalign_first_section_right">
                    <div class="invisalign_first_section_image_wrapper">
                        <img src="assets/img/treatments/smile_designing_1.png"
                             alt="Personalised smile designing consultation"
            ...
            <div class="row g-0 invisalign_second_section_row">
                <div class="col-lg-6 invisalign_second_section_left">
                    <div class="invisalign_second_section_content">
                        <h2 class="invisalign_second_section_title">
                            What Is Smile Designing?                        </h2>
                        <p class="invisalign_second_section_description">
                            Smile designing begins with a detailed evaluation of tooth position, shape, colour and proportion, together with your gums, lips, face and bite. Depending on your needs, the plan may include orthodontics, whitening, bonding, veneers, gum care or restorative treatment.                        </p>
                        <a href="contact.php" class="invisalign_second_section_button">
                            <span>Plan Your Smile Consultation</span>
                            <i class="bi bi-arrow-right" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-6 invisalign_second_section_right">
                    <div class="invisalign_second_section_image_wrapper">
                        <img src="assets/img/treatments/smile_designing_2.png"
                             alt="Healthy natural smile"
        ...
        <div class="container-fluid invisalign_third_section_container">
            <div class="invisalign_third_section_header">
                ...
                <h2 class="invisalign_third_section_title">
                    Why Choose Personalised Smile Design?                </h2>
            </div>
            ...
            <div class="row g-4 align-items-stretch">
                <div class="col-xl-9 col-lg-8">
                    <div class="invisalign_third_section_benefits">
                                ...
                                <div class="invisalign_third_section_card_text">
                                    Facially Driven<br>Planning                                </div>
                            </div>
                                                    <div class="invisalign_third_section_card">
                                <div class="invisalign_third_section_icon">
                                ...
                                <div class="invisalign_third_section_card_text">
                                    Natural Shade<br>Selection                                </div>
                            </div>
                                                    <div class="invisalign_third_section_card">
                                <div class="invisalign_third_section_icon">
                                ...
                                <div class="invisalign_third_section_card_text">
                                    Digital Preview<br>Where Suitable                                </div>
                            </div>
                                                    <div class="invisalign_third_section_card">
                                <div class="invisalign_third_section_icon">
                                ...
                                <div class="invisalign_third_section_card_text">
                                    Coordinated<br>Treatment Options                                </div>
                            </div>
                                            </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="invisalign_third_section_cta">
                        ...
                        <p>Bring your smile goals to a consultation and explore clinically appropriate options.</p>
                        <a href="contact.php" class="invisalign_third_section_cta_button">
                            <span>Start Your Smile Plan</span>
                            <i class="bi bi-arrow-right" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="row g-0 invisalign_forth_section_row">
                <div class="col-lg-8 invisalign_forth_section_left">
                    <div class="invisalign_forth_section_content">
                        ...
                        <div class="invisalign_forth_section_steps">
                                    ...
                                    <h3>Discover</h3>
                                    <p>We listen to your goals<br>and concerns.</p>
                                </div>
                                                            <div class="invisalign_forth_section_step">
                                    <div class="invisalign_forth_section_step_top">
                                        <div class="invisalign_forth_section_icon">
                                    ...
                                    <h3>Analyse</h3>
                                    <p>Photos, scans and records<br>guide the assessment.</p>
                                </div>
                                                            <div class="invisalign_forth_section_step">
                                    <div class="invisalign_forth_section_step_top">
                                        <div class="invisalign_forth_section_icon">
                                    ...
                                    <h3>Design</h3>
                                    <p>We build and explain<br>your treatment options.</p>
                                </div>
                                                            <div class="invisalign_forth_section_step">
                                    <div class="invisalign_forth_section_step_top">
                                        <div class="invisalign_forth_section_icon">
                                    ...
                                    <h3>Create &amp; Review</h3>
                                    <p>Care is completed in stages<br>with planned reviews.</p>
                                </div>
                                                    </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 invisalign_forth_section_right">
                    <div class="invisalign_forth_section_image_wrapper">
                        <img src="assets/img/treatments/smile_makeover_sq.png"
                             alt="Healthy natural smile"
        ...
        <div class="rootcanal_fourth_section_process_card">
            ...
            <div class="rootcanal_fourth_section_header">
                <h2 class="rootcanal_fourth_section_title">
                    THE SMILE DESIGNING TREATMENT PROCESS
                </h2>
            ...
            <div class="rootcanal_fourth_section_steps_flow">
                ...
                <div class="rootcanal_fourth_section_step_item">
                    ...
                    <div class="rootcanal_fourth_section_icon">
                        <img src="./assets/img/icons/dental-examination.png" alt="Smile Consultation and Evaluation">
                    </div>
                    <h3 class="rootcanal_fourth_section_step_title">Smile Consultation &amp; Evaluation</h3>
                    <p class="rootcanal_fourth_section_step_desc">
                        We evaluate your teeth, gums, facial features, and smile goals to understand the changes you desire.
                    </p>
                </div>
                ...
                <div class="rootcanal_fourth_section_step_item">
                    ...
                    <p class="rootcanal_fourth_section_step_desc">
                        Digital photographs and scans are used to analyze tooth shape, alignment, proportions, and smile aesthetics.
                    </p>
                </div>
                ...
                <div class="rootcanal_fourth_section_step_item">
                    ...
                    <p class="rootcanal_fourth_section_step_desc">
                        A personalized treatment plan is created to improve the shape, color, alignment, and overall balance of your smile.
                    </p>
                </div>
                ...
                <div class="rootcanal_fourth_section_step_item">
                    ...
                    <p class="rootcanal_fourth_section_step_desc">
                        Recommended treatments such as whitening, veneers, bonding, or alignment are performed based on your smile plan.
                    </p>
                </div>
                ...
                <div class="rootcanal_fourth_section_step_item">
                    ...
                    <p class="rootcanal_fourth_section_step_desc">
                        We review the final result and provide guidance to help maintain your healthy, natural-looking smile.
                    </p>
                </div>
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="invisalign_fifth_section_intro">
                        ...
                        <h2 class="invisalign_fifth_section_title">
                            Your Features,<br>Your Signature Smile                        </h2>
                        <p class="invisalign_fifth_section_description">
                            The goal is a smile that feels balanced, healthy and true to you.                        </p>
                ...
                <div class="col-xl-3 col-lg-3">
                    <div class="invisalign_fifth_section_testimonial">
                        ...
                        <p class="invisalign_fifth_section_quote">
                            Every design starts with oral health and function before cosmetic treatment choices are finalised.                        </p>
