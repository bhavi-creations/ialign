                ...
                <div class="col-lg-5 invisalign_first_section_left">
                    ...
                    <div class="invisalign_first_section_content">
                        ...
                        <div class="invisalign_first_section_eyebrow">
                            LASER GUM TREATMENT                        </div>

                        <h1 class="invisalign_first_section_title">
                            Precise Support<br>for Healthier Gums                        </h1>

                        <p class="invisalign_first_section_description">
                            Assessment-led gum care in which dental lasers may support selected periodontal or soft-tissue procedures when clinically appropriate.                        </p>
                ...
                <div class="col-lg-6 invisalign_second_section_left">
                    <div class="invisalign_second_section_content">
                        <h2 class="invisalign_second_section_title">
                            What Is Laser-Assisted Gum Treatment?                        </h2>
                        <p class="invisalign_second_section_description">
                            Dental lasers can be used for selected gum procedures, sometimes alongside professional cleaning, scaling and root planing or other periodontal care. The correct approach depends on the diagnosis and severity of the gum condition; laser treatment is not a single solution for every case.                        </p>
                        <a href="contact.php" class="invisalign_second_section_button">
                            <span>Book a Gum Health Assessment</span>
                            <i class="bi bi-arrow-right" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
        ...
        <div class="container-fluid invisalign_third_section_container">
            <div class="invisalign_third_section_header">
                ...
                <h2 class="invisalign_third_section_title">
                    Why Choose Assessment-Led Gum Care?                </h2>
            </div>
            ...
            <div class="row g-4 align-items-stretch">
                <div class="col-xl-9 col-lg-8">
                    <div class="invisalign_third_section_benefits">
                                ...
                                <div class="invisalign_third_section_card_text">
                                    Patient-Specific<br>Settings                                </div>
                            </div>
                                                    <div class="invisalign_third_section_card">
                                <div class="invisalign_third_section_icon">
                                ...
                                <div class="invisalign_third_section_card_text">
                                    Recovery &amp; Home<br>Care Guidance                                </div>
                            </div>
                                                    <div class="invisalign_third_section_card">
                                <div class="invisalign_third_section_icon">
                                    <i class="bi bi-calendar-check" aria-hidden="true"></i>
                                ...
                                <div class="invisalign_third_section_card_text">
                                    Periodontal<br>Maintenance                                </div>
                            </div>
                                            </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="invisalign_third_section_cta">
                        ...
                        <p>Bleeding, swelling, recession or persistent bad breath deserves a professional gum assessment.</p>
                        <a href="contact.php" class="invisalign_third_section_cta_button">
                            <span>Schedule a Gum Check</span>
                            <i class="bi bi-arrow-right" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-8 invisalign_forth_section_left">
                    <div class="invisalign_forth_section_content">
                        ...
                        <div class="invisalign_forth_section_steps">
                                    ...
                                    <h3>Gum Examination</h3>
                                    <p>We assess gum tissues,<br>pockets and risk factors.</p>
                                </div>
                                                            <div class="invisalign_forth_section_step">
                                    <div class="invisalign_forth_section_step_top">
                                        <div class="invisalign_forth_section_icon">
                                    ...
                                    <p>Treatment is selected for<br>your specific condition.</p>
                                </div>
                                                            <div class="invisalign_forth_section_step">
                                    <div class="invisalign_forth_section_step_top">
                                        <div class="invisalign_forth_section_icon">
                                    ...
                                    <h3>Targeted Care</h3>
                                    <p>Laser and other methods<br>are used when indicated.</p>
                                </div>
                                                            <div class="invisalign_forth_section_step">
                                    <div class="invisalign_forth_section_step_top">
                                        <div class="invisalign_forth_section_icon">
                                    ...
                                    <h3>Maintenance</h3>
                                    <p>Reviews and home care help<br>support gum health.</p>
                                </div>
                                                    </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="invisalign_fifth_section_intro">
                        ...
                        <h2 class="invisalign_fifth_section_title">
                            Healthy Gums Need<br>Consistent Care                        </h2>
                        <p class="invisalign_fifth_section_description">
                            Treatment is only one part of controlling gum disease and protecting your smile.                        </p>
                ...
                <div class="col-xl-3 col-lg-3">
                    <div class="invisalign_fifth_section_testimonial">
                        ...
                        <p class="invisalign_fifth_section_quote">
                            We combine a clear diagnosis, appropriate clinical treatment and ongoing maintenance rather than relying on technology alone.                        </p>
