            ...
            <div class="col-lg-7 appointment_first_section_right">
                ...
                <div class="appointment_first_section_image_wrapper">
                    ...
                    <img src="assets/img/contact.png"
                         ...
                         class="appointment_first_section_image">
        ...
        <div class="row g-4 appointment_second_section_top">
            ...
            <div class="col-xl-8 col-lg-7">
                ...
                <div class="appointment_second_section_form_card">
                    ...
                    <form class="appointment_second_section_form">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       name="name"
                                       class="form-control appointment_second_section_input"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="treatment"
                                        class="form-select appointment_second_section_input"
                                        required>
                                    ...
                                    <option value="Advanced Teeth Cleaning">
                                    ...
                                    <option value="Laser Gum Treatment">
                                        Laser Gum Treatment
                                    </option>

                                    <option value="TMJ Joint Pain Treatment">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="message"
                                          class="form-control appointment_second_section_message"
                            ...
                            <div class="col-12">
                                ...
                                <button type="submit"
                                        class="appointment_second_section_submit">
                ...
                <div class="appointment_second_section_why_card">
                    ...
                    <div class="appointment_second_section_why_item">
                        ...
                        <div class="appointment_second_section_why_text">
                            ...
                            <span>
                                A relaxing environment for your visit.
                            </span>
                    ...
                    <div class="appointment_second_section_why_item">
                        ...
                        <div class="appointment_second_section_why_text">
                            ...
                            <span>
                                Care tailored to your smile goals.
                            </span>
                    ...
                    <div class="appointment_second_section_clinic_image">
                        ...
                        <!-- <img src="assets/img/appointment/appointment-clinic.jpg"
            ...
            <div class="col-lg-4">
                ...
                <div class="appointment_second_section_contact_card">
                    ...
                    <div class="appointment_second_section_contact_content">
                        ...
                        <a href="https://maps.app.goo.gl/84v8D8kZjPxFVNVt6" target="_blank"
                           class="appointment_second_section_direction">
                ...
                <div class="appointment_second_section_contact_card">
                    ...
                    <div class="appointment_second_section_contact_content">
                        ...
                        <a href="tel:+919902686388"
                           class="appointment_second_section_phone">
                            +91 990 268 6388
                        </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="appointment_second_section_contact_card">
                    ...
                    <div class="appointment_second_section_contact_content">
                        ...
                        <a href="mailto:info@ialign.dental"
                           class="appointment_second_section_email">
                            info@ialign.dental
                        </a>
